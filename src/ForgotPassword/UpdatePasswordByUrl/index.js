...
export default function PasswordReset({customer}) {
    ...
    let [updateCustomer, { loading, data, error }] = useMutation(RESET_PASSWORD);    
        ...
        if(formData.password.length >= 5) {
            if(formData.password === formData.confirmPassword) {                
                try {
                    ...
                    let { customer, customerUserErrors } = responseData.data.customerResetByUrl;
    ...
    return <div className="container">
        <div className="row">
            <form className="p-3 w-50 mx-auto">
                <FormLogo heading="Reset Password" />
